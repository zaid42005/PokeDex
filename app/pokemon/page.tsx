...
const Pokemon = () => {
  ...
  return (
    <div className='min-h-screen bg-slate-500 flex flex-col justify-center items-center gap-4'>
        ...
        {/* <img src = 'https://wallpapercave.com/wp/wp3170174.jpg' /> */}
        
        
        <img className="h-35 w-40" src={showFrontImage? pokeFrontUrl: pokeBackUrl} alt="Pokemon" />

        <button className="bg-amber-100 text-black px-2 py-1 rounded-lg" onClick={toggleImage}>switch</button>
